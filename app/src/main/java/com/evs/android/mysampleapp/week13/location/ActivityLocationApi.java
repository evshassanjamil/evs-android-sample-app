...
import com.evs.android.mysampleapp.BuildConfig;
...
public class ActivityLocationApi extends AppCompatActivity {
    ...
    private static final String TAG = ActivityLocationApi.class.getSimpleName();
    ...
    private void googleMapsLocationIntent(double lat, double lng) {
                        ...
                        if (task.isSuccessful() && task.getResult() != null) {
                            ...
                            mTvLocation.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    googleMapsLocationIntent(mLastLocation.getLatitude(),
    ...
    private void showSnackbar(final String text) {
        View container = findViewById(R.id.llLocationApiRoot);
        if (container != null) {
